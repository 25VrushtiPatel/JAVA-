...
public class TreeSetDemo {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student(101, "Heer", 87));
        students.add(new Student(104, "Pihu", 71));
        students.add(new Student(103, "Anshi", 67));
        students.add(new Student(102, "Sita", 72));
